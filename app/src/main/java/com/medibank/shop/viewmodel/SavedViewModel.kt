...
@HiltViewModel
class SavedViewModel @Inject constructor(private val useCase: INewsUseCase) :
    BaseNewsViewModel(), SelectedSavedData{
    ...
    override fun onSavedData(url: String) {
        eventURLSelected.value = url
    }
}

interface SelectedSavedData {
    fun onSavedData( url: String)
}
